...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x3117952F078F78C02BA624ec14CdCEE77a632C10", "edition-drop").contract;

  // トークンコントラクトの初期化
  const token = useContract("0x7AE33069E7f12b7C5eFcffb9edCD5fBfc0Daf077", "token").contract;

  // 投票コントラクトの初期化
  const vote = useContract("0x4A3Bd5824569c8d5899745a7dCBD54768ACF628F", "vote").contract;
    ...
    return (
      <div className={styles.container}>
        <main className={styles.main}>
          ...
          Welcome to <br />Everything For the Party DAO!!
          </h1>
